...
class _RawNode(typing.Generic[RawNodeType], typing.Generic[RawFrameType]):
    ...
    # get_frame_async_raw is deprecated
    @typing.overload
    def get_frame_async_raw(self, n: int, cb: typing.Callable[[RawNodeType, int, RawFrameType], None]) -> None: ...
    @typing.overload
    def get_frame_async_raw(self, n: int, cb: _Future[RawFrameType], future_wrapper: typing.Optional[typing.Callable[..., None]] = None) -> _Future[RawFrameType]: ...
